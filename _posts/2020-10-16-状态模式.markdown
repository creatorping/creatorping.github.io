...
![image-20201016203053551]( typora-user-images\image-20201016203053551.png)

## 实现
+ 一家糖果公司想完成一个自动糖果售货机的设计，给出如下状态转换图，请求帮忙实现项目。![image-20201016200255438]( typora-user-images\image-20201016200255438.png)
